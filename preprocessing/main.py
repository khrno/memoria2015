...
if ( __name__ == "__main__"):
    ...
    options, remainder = getopt.getopt(sys.argv[1:], 'i:o:p:t:cvh',
                                       ['input=', 'output=', 'partition=', 'pos_tag=', 'stemPorter', 'stemLancaster',
                                        'stemSnowball', 'fthreshold=', 'counter', 'verbose', 'help'])
